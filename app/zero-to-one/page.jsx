...
export function ItsFor() {
  ...
  return (
    <div className="flex flex-col justify-center items-center md:my-32 my-16 md:gap-20 gap-8 p-4">
      <span className="hidden border-school"></span>
      ...
      <div
        className={
          "sm:w-10/12 sm:p-16 px-4 sm:m-auto py-8 sm:py-16 bg-neutral-800 rounded-3xl border-2 grid gap-8 lg:grid-cols-2 grid-cols-1 border-" +
          color
        }
      >
        {data.map((d, i) => (
