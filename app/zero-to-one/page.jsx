...
const Hero2 = () => {
	return (
		<div className="flex md:flex-nowrap flex-wrap-reverse items-center justify-evenly my-16">
...
function About() {
	return (
		<div className="w-full flex justify-center items-center my-32 text-neutral-900">
			<div className="w-10/12 bg-neutral-50 rounded-3xl border-2 border-zero flex flex-col justify-center items-center p-16">
				...
				<div className="flex flex-row md:flex-nowrap flex-wrap gap-10 mt-10">
					<img
						src="/zero/about.svg"
						alt="zero1"
						className="border border-zero rounded-3xl p-4 w-[400px] h-[400px] bg-neutral-100"
					/>
					<ul className="zero-about-list border border-zero rounded-3xl p-6 w-[400px] h-[400px] list-disc list-inside bg-neutral-100 text-xl font-light">
						<li>
	...
	return (
		<div className="flex flex-col justify-center items-center gap-10 my-32">
			<div className="text-center">
				<h1 className="uppercase text-6xl">cohort speakers & mentors</h1>
				<p className="text-xl mt-4">
...
function ItsFor() {
	...
	return (
		<div className="flex flex-col justify-center items-center my-32 gap-20 ">
			...
			<div className="w-10/12 bg-neutral-800 rounded-3xl border-2 border-zero p-16 py-20 grid gap-8 grid-cols-2  ">
				{data.map((d, i) => (
					<div
						key={i}
						className=" bg-neutral-100 text-neutral-800 p-10 rounded-2xl flex flex-col gap-10"
					>
						<h1 className=" text-4xl font-bold ">{d.title}</h1>
						<p className=" text-xl ">{d.description}</p>
					</div>
				))}
			</div>
		</div>
